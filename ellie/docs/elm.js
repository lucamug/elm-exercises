		...
		return _Utils_Tuple2(
			{
				...
				localStorage: _Debug_todo(
					'Exercises',
					{
						start: {line: 464, column: 24},
						end: {line: 464, column: 34}
					})('TODO'),
				menuOver: false,
				modelExercise: modelExercise,
				resultExerciseData: A2($miniBill$elm_codec$Codec$decodeString, $author$project$Internal$Codecs$codecExerciseData, flags.exerciseData),
				resultIndex: A2(
		...
		switch (msg.$) {
			...
			case 'PortLocalStoragePop':
				...
				return _Debug_todo(
					'Exercises',
					{
						start: {line: 582, column: 13},
						end: {line: 582, column: 23}
					})('xxx');
			default:
				var string = msg.a;
				return _Utils_Tuple2(
